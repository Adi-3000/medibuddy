...
include('func.php');
include('newfunc.php');
$con = mysqli_connect("localhost", "root", "", "mBuddy");
...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> MEDI BUDDYs</h2></br>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> MEDI BUDDY </a>
